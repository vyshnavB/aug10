...
class item_categories(models.Model):
    item_categories=models.CharField(max_length=255,blank=True)  


class intrest(models.Model):
    item_categories=models.ForeignKey(item_categories, on_delete=models.CASCADE,null=True)
    intrest_name=models.CharField(max_length=255,blank=True)  
...
class friend_request(models.Model):
    from_user=models.ForeignKey(User,related_name='from_user',on_delete=models.CASCADE,blank=True,default=True)
    to_user=models.ForeignKey(User,related_name='to_user',on_delete=models.CASCADE,blank=True,default=True)
    to_page=models.ForeignKey(page,related_name='page_to',on_delete=models.CASCADE,blank=True,default=True)
...
class Notifications(models.Model):
    ...
    to_page=models.ForeignKey(page,related_name='pg_noti',on_delete=models.CASCADE,null=True,blank=True)
