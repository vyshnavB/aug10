...
urlpatterns = [
   ...
   path('intrest_page/', views.intrest_page, name='intrest_page'),
    path('search/', views.intrest_page, name='search_results'),


    path('save_cropped_image/<int:pk>/', views.save_cropped_image, name='save_cropped_image'),
    ...
    path("n/user_create_post_organization/<int:pk>", views.user_create_post_organization, name="user_create_post_organization"),
    ...
    path('intrest_follow_editprofile/<int:pk>/<int:id>', views.intrest_follow_editprofile, name='intrest_follow_editprofile'),
    path('intrest_unfollow_editprofile/<int:pk>/<int:id>', views.intrest_unfollow_editprofile, name='intrest_unfollow_editprofile'),
    ...
    path('normal_createpost/<int:pk>',views.normal_createpost,name='normal_createpost'),
    ...
    path('sent_friend_request_org/<int:userid>',views.sent_friend_request_org,name='sent_friend_request_org'),
    ...
    path('delete_frd_org/<int:pk>',views.delete_frd_org,name='delete_frd_org'),
    ...
    path('edit_org_giz_post/<int:post_id>/<int:ik>/', views.edit_org_giz_post, name='edit_org_giz_post'),
     ...
     path('item_category_create/', views.item_category_create, name='item_category_create'),
...
# admin
    ...
    path('convert-to-excel/', views.convert_to_excel, name='convert_to_excel'),
     path('pageadmin',views.pageadmin,name='pageadmin'),
     
      path('download-excel/<int:excel_data_id>/', views.download_excel, name='download_excel'),
